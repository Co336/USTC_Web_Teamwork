...
write_index_table_to_csv('jieba\data\\book_index_list_raw.csv',book_index_table_skip_builded)
# hash_index_table_storage(book_index_table_skip_builded,'jieba\data\\book_hash_list.pkl','jieba\data\\book_index_list')
# print(hash_search("封面",'jieba\data\\book_hash_list.pkl','jieba\data\\book_index_list'))
...
# hash_index_table_storage(movie_index_table_skip_builded,'jieba\data\movie_hash_list.pkl','jieba\data\movie_index_list')
# print(hash_search("雷人",'jieba\data\movie_hash_list.pkl','jieba\data\movie_index_list'))