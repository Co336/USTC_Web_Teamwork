...
file_book_hash_list = "jieba\data\\book_hash_list.pkl"
file_movie_hash_list = "jieba\data\\movie_hash_list.pkl"
...
def term_compress():
    ...
    # # 存储到文件
    # with open("jieba\data\compressed_book_terms.pkl", "wb") as f:
    #     pickle.dump((compressed_book_block, compressed_book_pointers), f)

    # with open("jieba\data\compressed_movie_terms.pkl", "wb") as f:
    #     pickle.dump((compressed_movie_block, compressed_movie_pointers), f)
    # # 从文件读取
    # with open("jieba\data\compressed_movie_terms.pkl", "rb") as f:
...
# 书籍的压缩前后文件
book_input_shelve_file = "jieba\data\\book_index_list"
book_output_shelve_file = "jieba\data\compressed_book_index"
# 电影的压缩前后文件
movie_input_shelve_file = "jieba\data\\movie_index_list"
movie_output_shelve_file = "jieba\data\compressed_movie_index"
# 索引压缩
